...
SPOTIPY_REDIRECT_URI = 'http://localhost:5000/callback'  # Local Flask app callback URL
...
def callback():
    ...
    # Redirect back to your Streamlit app hosted at the specific URL with the token
